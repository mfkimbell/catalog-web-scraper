...
<img width="850" alt="workflow devops 2" src="https://github.com/mfkimbell/catalog-web-scraper/assets/107063397/c045e02a-2422-49b2-af84-6598260c7fc2">
...
I created a `Kicker.py` that publishes the first work item so that the **Main Page** work item is not published every time that `Scraper.py` is used to recieve and process data. 
...
From the PostgreSQL database, this is an example of a book record:
